...
const PostsIndex = ({ posts }) => {
    ...
    return (
        ...
        >
            ...
            <div className="grid gap-4 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                {posts.data.map((post) => (
                    <div
                        key={post.id}
                    ...
                    >
                        ...
                        <p className="mt-2 text-gray-200">{post.content.substring(0, 150)}...</p>
                    {user && (user.id === post.user.id || user.id === 1) && (
                        <>
                            <form
                            method="GET"
                        ...
                        >
                            ...
                            <form
                                ...
                                className="text-right transform "
                            >
